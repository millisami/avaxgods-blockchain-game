...
const blankAccount = "0x0000000000000000000000000000000000000000"

const AddNewEvent = (eventFilter, provider, cb) => {
  provider.removeListener(eventFilter) //not have multiple listeners
...
export const createEventListeners = ({
  ...
  AddNewEvent(RoundEndedEventFilter, provider, ({ args }) => {
    ...
    for (let i = 0; i < args.damagedPlayers.length; i++) {
      if (args.damagedPlayers[i] !== blankAccount) {
